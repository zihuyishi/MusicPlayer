...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   {
	   lyric[0] = L"摇啊摇 十五摇过春分 就是外婆桥";
	   lyric[1] = L"盼啊盼 阿麽阿麽地甜甜叫";
	   lyric[2] = L"吵啊吵 米花糖挂嘴角 总是吃不饱";
	   lyric[3] = L"美啊美 小脚桥上翘啊翘";
	   lyric[4] = L"...........";
   ...
   lyricController->LyricForm_SetLyric(L"歌曲：外婆桥\t歌词：洛天依");
...
void PlayMusic()
{
	...
	player->AddMusic(L"D:\\lyric\\稻香.mp3");
	player->PlayNext();
}